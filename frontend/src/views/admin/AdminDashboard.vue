...
const tableNameLabels: Record<string, string> = {
  ...
  community_candidates: '社区候选',
  daily_reports: '日报',
  evolution_jobs: '进化任务',
  evolution_runs: '进化运行',
  evolution_steps: '进化步骤',
  evolution_artifacts: '进化产物',
  memories: '记忆',
  scan_jobs: '扫描任务',
  sessions: '会话',
  skill_usage: 'Skill 使用',
  skill_variants: 'Skill 变体',
  skill_iterations: 'Skill 迭代',
  skills: 'Skills',
  source_configs: '数据源配置',
  team_skills_cache: '团队缓存',
  workflow_clusters: '工作流聚类',
  workflow_recommendations: '工作流推荐',
}
